...
class ProfileVip1yearViewHolder(val constraintLayout: ConstraintLayout) : BaseViewHolder(constraintLayout) {
...
fun ProfileVip1yearViewHolder.renderUI() {
    ...
    val w = (utils.variable.displayWidth - 32 ) - 75
    tape
        .constrainTopToTopOf(back, 11)
        .constrainRightToRightOf(back, w)
}

fun ProfileVip1yearViewHolder.initialize(image: Int, title: String, describe: String, price: String) {
